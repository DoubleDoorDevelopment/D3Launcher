package net.doubledoordev.launcher.util.winreg;
...
import net.doubledoordev.launcher.util.OSUtils;
...
public class JavaFinder
{
    ...
    private static List<String> searchRegistry(String key, int wow64, final List<String> previous)
    {
        ...
        {
            LOGGER.error("Error Searching windows registry for java versions", t);
        }
        return result;
    }
    ...
    protected static List<JavaInfo> findWinJavas()
    {
        ...
        for (String javaPath : javaExecs)
        {
            ...
            {
                LOGGER.error("Error while creating JavaInfo", e);
            }
        }
        return result;
    }
    ...
    public static JavaInfo parseJavaVersion()
    {
        if (preferred == null)
        {
            ...
            LOGGER.info("Preferred: " + String.valueOf(preferred));
        }
        ...
        {
            LOGGER.error("No Java versions found!");
            return null;
        }
    }
}
